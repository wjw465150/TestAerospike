...
//  }
  ...
  public static void main(String[] args) {
    if (args.length < 1) {
      System.out
          .println("用法:java -Xmx512m -cp ./classes:./lib/* wjw.test.aerospike.benchmark.GetBenchMarkMain 服务器1ip,服务器2ip,...");
      System.out
          .println("例如:java -Xmx512m -cp ./classes:./lib/* wjw.test.aerospike.benchmark.GetBenchMarkMain T1,T2,T3");
      System.exit(0);
    }
