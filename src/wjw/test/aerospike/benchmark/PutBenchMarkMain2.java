...
public class PutBenchMarkMain2 {
  ...
  public static void main(String[] args) {
    if (args.length < 1) {
      System.out
          .println("用法:java -Xmx512m -cp ./classes:./lib/* wjw.test.aerospike.benchmark.PutBenchMarkMain2 服务器1ip,服务器2ip,...");
      System.out
          .println("例如:java -Xmx512m -cp ./classes:./lib/* wjw.test.aerospike.benchmark.PutBenchMarkMain2 T1,T2,T3");
      System.exit(0);
    }

    PutBenchMarkMain2 testPut = new PutBenchMarkMain2();
